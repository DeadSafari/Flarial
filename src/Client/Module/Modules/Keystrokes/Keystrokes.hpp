	...
	void NormalRender(int index, std::string text, std::string value) override {
		...
		if (SDK::hasInstanced) {
			if (SDK::clientInstance->getLocalPlayer() != nullptr) {
				...
				D2D1_COLOR_F enabledColor = settings.getSettingByName<bool>("enabledRGB")->value ? FlarialGUI::rgbColor : FlarialGUI::HexToColorF(settings.getSettingByName<std::string>("enabledColor")->value);
				...
				D2D1_COLOR_F textEnabledColor = settings.getSettingByName<bool>("textEnabledRGB")->value ? FlarialGUI::rgbColor : FlarialGUI::HexToColorF(settings.getSettingByName<std::string>("textEnabledColor")->value);
