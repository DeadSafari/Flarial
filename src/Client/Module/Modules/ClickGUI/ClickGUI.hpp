...
public:
	...
	void SettingsRender() override {
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"Text Color",
			...
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(10, rectX + FlarialGUI::SettingsTextWidth("Text Color "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_text")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_text")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_text_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Text Color  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_text_setting", rectX + FlarialGUI::SettingsTextWidth("Text Color  ") + tooltipV * 4.125f, rectY, "The color of the text in the Click GUI.", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"Enabled Color",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(11, rectX + FlarialGUI::SettingsTextWidth("Enabled Color "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_enabled")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_enabled")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_enabled_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Enabled Color  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_enabled_setting", rectX + FlarialGUI::SettingsTextWidth("Enabled Color  ") + tooltipV * 4.125f, rectY, "The color of the enabled button in the Click GUI.", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"Disabled Color",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(12, rectX + FlarialGUI::SettingsTextWidth("Disabled Color "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_disabled")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_disabled")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_disabled_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Disabled Color  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_disabled_setting", rectX + FlarialGUI::SettingsTextWidth("Disabled Color  ") + tooltipV * 4.125f, rectY, "The color of the disabled button in the Click GUI.", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"Primary 1",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(13, rectX + FlarialGUI::SettingsTextWidth("Primary 1 "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_primary1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_primary1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_primary1_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Primary 1  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_primary1_setting", rectX + FlarialGUI::SettingsTextWidth("Primary 1  ") + tooltipV * 4.125f, rectY, "Color of active elements\nMain color of sliders\nBackground color of enabled toggles", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Primary 2  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_primary2_setting", rectX + FlarialGUI::SettingsTextWidth("Primary 2  ") + tooltipV * 4.125f, rectY, "Minor color of toggles and sliders\nText Indicator color", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"Primary 3",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(15, rectX + FlarialGUI::SettingsTextWidth("Primary 3 "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_primary3")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_primary3")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_primary3_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Primary 3  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_primary3_setting", rectX + FlarialGUI::SettingsTextWidth("Primary 3  ") + tooltipV * 4.125f, rectY, "Color of inactive elements\nUnfilled slider bar color\nInner color of color pickers\nBackground color of disabled toggles", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"Primary 4",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(16, rectX + FlarialGUI::SettingsTextWidth("Primary 4 "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_primary4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_primary4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_primary4_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Primary 4  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_primary4_setting", rectX + FlarialGUI::SettingsTextWidth("Primary 4  ") + tooltipV * 4.125f, rectY, "Base color of color pickers\nHover color of dropdown childrens", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"Secondary 1",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(17, rectX + FlarialGUI::SettingsTextWidth("Secondary 1 "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_secondary1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_secondary1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_secondary1_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Secondary 1  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_secondary1_setting", rectX + FlarialGUI::SettingsTextWidth("Secondary 1  ") + tooltipV * 4.125f, rectY, "Background color of settings", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Secondary 2  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_secondary2_setting", rectX + FlarialGUI::SettingsTextWidth("Secondary 2  ") + tooltipV * 4.125f, rectY, "Background color of navigation bar, tooltips, and buttons", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"Secondary 3",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(19, rectX + FlarialGUI::SettingsTextWidth("Secondary 3 "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_secondary3")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_secondary3")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_secondary3_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Secondary 3  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_secondary3_setting", rectX + FlarialGUI::SettingsTextWidth("Secondary 3  ") + tooltipV * 4.125f, rectY, "Background color of base Click GUI rectangle", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"Secondary 4",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(20, rectX + FlarialGUI::SettingsTextWidth("Secondary 4 "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_secondary4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_secondary4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_secondary4_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Secondary 4  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_secondary4_setting", rectX + FlarialGUI::SettingsTextWidth("Secondary 4  ") + tooltipV * 4.125f, rectY, "Background color of active Modules search bar", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Secondary 5  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_secondary5_setting", rectX + FlarialGUI::SettingsTextWidth("Secondary 5  ") + tooltipV * 4.125f, rectY, "Background color of navigation bar icons", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Secondary 6  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_secondary6_setting", rectX + FlarialGUI::SettingsTextWidth("Secondary 6  ") + tooltipV * 4.125f, rectY, "Background color of active navigation bar buttons", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("Secondary 7  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_secondary7_setting", rectX + FlarialGUI::SettingsTextWidth("Secondary 7  ") + tooltipV * 4.125f, rectY, "Outline color of tooltips", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"ModCard 1",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(22, rectX + FlarialGUI::SettingsTextWidth("ModCard 1 "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_mod1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_mod1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_mod1_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("ModCard 1  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_modcard1_setting", rectX + FlarialGUI::SettingsTextWidth("ModCard 1  ") + tooltipV * 4.125f, rectY, "Color of top rounded rectangle", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("ModCard 2  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_modcard2_setting", rectX + FlarialGUI::SettingsTextWidth("ModCard 2  ") + tooltipV * 4.125f, rectY, "Color of bottom rounded rectangle", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("ModCard 3  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_modcard3_setting", rectX + FlarialGUI::SettingsTextWidth("ModCard 3  ") + tooltipV * 4.125f, rectY, "Background color of module icons\nOuter color of module settings icon", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);
		...
		FlarialGUI::FlarialTextWithFont(rectX, rectY, L"ModCard 4",
			...
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::ColorPicker(25, rectX + FlarialGUI::SettingsTextWidth("ModCard 4 "), rectY - Constraints::SpacingConstraint(0.017, textWidth), ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_mod4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_mod4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_mod4_rgb")->value);
		FlarialGUI::FlarialTextWithFont(rectX + FlarialGUI::SettingsTextWidth("ModCard 4  ") + tooltipV * 4.125f, rectY, L"(i)",
			textWidth * 6.9f, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING,
			Constraints::SpacingConstraint(1.05, textWidth),
			DWRITE_FONT_WEIGHT_NORMAL);
		FlarialGUI::Tooltip("colors_modcard4_setting", rectX + FlarialGUI::SettingsTextWidth("ModCard 4  ") + tooltipV * 4.125f, rectY, "Inner color of module settings icon", FlarialGUI::SettingsTextWidth("(i)"), tooltipV, true, true);

		// next element

		FlarialGUI::UnsetScrollView();

		FlarialGUI::ColorPickerWindow(10, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_text")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_text")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_text_rgb")->value);
		FlarialGUI::ColorPickerWindow(11, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_enabled")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_enabled")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_enabled_rgb")->value);
		FlarialGUI::ColorPickerWindow(12, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_disabled")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_disabled")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_disabled_rgb")->value);
		FlarialGUI::ColorPickerWindow(13, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_primary1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_primary1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_primary1_rgb")->value);
		FlarialGUI::ColorPickerWindow(14, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_primary2")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_primary2")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_primary2_rgb")->value);
		FlarialGUI::ColorPickerWindow(15, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_primary3")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_primary3")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_primary3_rgb")->value);
		FlarialGUI::ColorPickerWindow(16, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_primary4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_primary4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_primary4_rgb")->value);
		FlarialGUI::ColorPickerWindow(17, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_secondary1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_secondary1")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_secondary1_rgb")->value);
		FlarialGUI::ColorPickerWindow(18, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_secondary2")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_secondary2")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_secondary2_rgb")->value);
		FlarialGUI::ColorPickerWindow(19, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_secondary3")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_secondary3")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_secondary3_rgb")->value);
		...
		FlarialGUI::ColorPickerWindow(25, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<std::string>("colors_mod4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<float>("o_colors_mod4")->value, ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("colors_mod4_rgb")->value);
	}
};