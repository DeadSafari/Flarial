...
public:
    ...
    void SettingsRender() override {
        ...
        percent = FlarialGUI::Slider(1, toggleX + Constraints::SpacingConstraint(0.60, textWidth) +
        ...
        FlarialGUI::FlarialTextWithFont(toggleX, toggleY, L"FPS Spoofer", textWidth * 3.0f, textHeight,
                                        DWRITE_TEXT_ALIGNMENT_LEADING,
                                        Constraints::RelativeConstraint(0.12, "height", true),
                                        DWRITE_FONT_WEIGHT_NORMAL);

        percent = FlarialGUI::Slider(69, toggleX + FlarialGUI::SettingsTextWidth("FPS Spoofer "),
                                     toggleY, this->settings.getSettingByName<float>("fpsSpoofer")->value);
